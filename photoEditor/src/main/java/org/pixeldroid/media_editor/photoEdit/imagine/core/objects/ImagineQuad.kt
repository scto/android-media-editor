...
constructor(
    ...
    fun draw() = releaseSafe {
        ...
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, elementCount, GLES20.GL_UNSIGNED_SHORT, 0)
    ...
    companion object {
        ...
        /**
         * Number of coordinates representing each vertex. Since this is essentially a 2D quad, so 2
         * coordinates are required.
         */
        private const val COORDS_PER_VERTEX = 2

        /**
         * Interleaved vertex coordinates followed by corresponding texture coordinates,
         * representing a quad
         */
        ...
        /**
         * Indices into the vertex buffer to describe two anti-clockwise triangles to be rendered
         * representing a quad
         */
        private val indices =
            shortArrayOf(
