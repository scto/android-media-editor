...
sealed class ImagineShader {
    ...
    class Compiled @VisibleForTesting constructor(
        ...
        fun linkWith(other: Compiled, releaseOnFailure: Boolean = false): Program? = releaseSafe {
            ...
            // Bind attributes, has to be done before linking the program
            GLES20.glBindAttribLocation(program, 0, "vTexCoords")
            GLES20.glBindAttribLocation(program, 0, "fragColor")
