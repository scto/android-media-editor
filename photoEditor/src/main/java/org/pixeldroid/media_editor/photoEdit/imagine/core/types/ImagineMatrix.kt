...
/** Represents a 16-component Float matrix and facilitates common operations on it */
class ImagineMatrix @VisibleForTesting constructor() {
    ...
    companion object {
        ...
        /**
         * Instantiates a matrix scaled across x and y axes to aspect correct an image in its
         * container. The z axis remains unit
         *
         ...
         * @return An [ImagineMatrix]
         */
        fun ofAspectFit(imageAspectRatio: Float, containerAspectRatio: Float): ImagineMatrix =
            ImagineMatrix()
                .scale(
                    if (imageAspectRatio > containerAspectRatio) 1.0f
                    else (imageAspectRatio / containerAspectRatio),
                    if (imageAspectRatio < containerAspectRatio) 1.0f
                    else (containerAspectRatio / imageAspectRatio),
                    1.0f,
                )
